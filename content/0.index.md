...
#description
dnser is a library that allows you to resolve any TLDs from Handshake to ICANN, also you can use it as an API to get the information of any TLD and resolve it.
